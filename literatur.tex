...
%Ruhnke, K. (1995): Konzernbuchführung, Diss., Düsseldorf 1995
    ...
    \bibitem{Bradford2011} Bradford, R. (2011) {\sl Effective MySQL: Optimizing SQL Statements}, McGraw-Hill Osborne Media, 2011
    \bibitem{refman1}{\sl Optimizing Queries with EXPLAIN} http://dev.mysql.com/doc/refman/5.6/en/using-explain.html
    \bibitem{refman2}{\sl EXPLAIN Output Format} http://dev.mysql.com/doc/refman/5.6/en/explain-output.html
